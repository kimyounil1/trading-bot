...
class SettingsTest(unittest.TestCase):
    ...
    def test_load_repo_strategy_config_accepts_position_sizing_keys(self) -> None:
        ...
        self.assertTrue(loaded.rank_quality_risk_enabled)
        self.assertEqual(loaded.rank_quality_one_bad_multiplier, 0.5)
        self.assertEqual(loaded.rank_quality_two_bad_multiplier, 0.25)
        self.assertTrue(loaded.rank_quality_block_leverage_when_both_bad)
        ...
        self.assertFalse(loaded.prefer_leveraged_products)
        self.assertFalse(loaded.auto_discover_leveraged_products)
        self.assertFalse(loaded.allow_single_name_leveraged_products)
        self.assertIn("TQQQ", loaded.leveraged_etf_allowlist)
        self.assertIn("SOXL", loaded.leveraged_etf_allowlist)
        self.assertNotIn("PLUL", loaded.leveraged_etf_allowlist)
        self.assertNotIn("AMDL", loaded.leveraged_etf_allowlist)
