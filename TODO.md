...
| 1-C | **stop5_trail10 트라이얼 종결 처리** | [x] **종결 (07-08)** | `--close` 플래그 추가 후 superseded 사유 기록 — 06-24 exit 스윕 승격(tr 0.15/tp 0.08)이 트라이얼 config를 덮어써 평가 불능. 리포트 status **CLOSED** 고정, 데일리 런에도 유지 |
